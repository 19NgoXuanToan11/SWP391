                      ...
                      },
                      {
                        ...
                        label: (
                          <div className="flex items-center gap-3 py-1">
                            ...
                            <span className="font-medium">Đã giao hàng</span>
                          </div>
                        ),
                      },
                      {
                  ...
                  >
                    ...
                    <div className="px-6 py-2 border-t border-b border-gray-100 bg-gray-50">
                      <div className="flex flex-wrap items-center justify-between gap-y-2">
                        ...
                        {/* Thêm dòng chữ "Bạn có 12 tiếng để hủy đơn hàng" */}
                        {/* Pending Status - show for pending orders */}
                        {order.status === "pending" && (
                          <div className="relative flex items-center">
                            <div className="flex items-center gap-2 bg-yellow-50 px-4 py-2.5 rounded-md border border-yellow-200 shadow-sm">
                              <ClockCircleOutlined className="text-yellow-500" />
                              <p className="text-sm text-yellow-700 font-medium">
                                <span className="text-yellow-500 font-normal italic opacity-75 ml-1">
                                  Bạn có 12 tiếng để hủy đơn hàng
                                </span>
                              </p>
                            </div>
                          </div>

...
import SidebarStaff from "../../../components/sidebar/staff/SidebarStaff.jsx";
...
const OrdersPage = () => {
  ...
  // Thêm state để lưu tham chiếu đến RangePicker
  const datePickerRef = React.useRef(null);

  // Thêm một tham chiếu cho Select component
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto p-8">
        ...
        >
          ...
          {/* Filters */}
          <Card className="rounded-3xl shadow-md border-0 bg-gradient-to-r from-white/90 to-white/70 backdrop-blur-xl p-4">
